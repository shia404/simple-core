...
import (
	...
	department2 "github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/department"
	dictionary2 "github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/dictionary"
	...
	"github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/migrate"
	"github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/oauthprovider"
	position2 "github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/position"
	...
	user2 "github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/user"
...
func (c *DepartmentClient) DeleteOneID(id uint64) *DepartmentDeleteOne {
	builder := c.Delete().Where(department2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *DepartmentClient) Get(ctx context.Context, id uint64) (*Department, error) {
	return c.Query().Where(department2.ID(id)).Only(ctx)
}
...
func (c *DepartmentClient) QueryParent(_m *Department) *DepartmentQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(department2.Table, department2.FieldID, id),
			sqlgraph.To(department2.Table, department2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, department2.ParentTable, department2.ParentColumn),
		)
...
func (c *DepartmentClient) QueryChildren(_m *Department) *DepartmentQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(department2.Table, department2.FieldID, id),
			sqlgraph.To(department2.Table, department2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, department2.ChildrenTable, department2.ChildrenColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *DepartmentClient) QueryUsers(_m *Department) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, department2.UsersTable, department2.UsersColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *DictionaryClient) DeleteOneID(id uint64) *DictionaryDeleteOne {
	builder := c.Delete().Where(dictionary2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *DictionaryClient) Get(ctx context.Context, id uint64) (*Dictionary, error) {
	return c.Query().Where(dictionary2.ID(id)).Only(ctx)
}
...
func (c *DictionaryClient) QueryDictionaryDetails(_m *Dictionary) *DictionaryDetailQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(dictionary2.Table, dictionary2.FieldID, id),
			sqlgraph.To(dictionarydetail2.Table, dictionarydetail2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, dictionary2.DictionaryDetailsTable, dictionary2.DictionaryDetailsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *DictionaryDetailClient) DeleteOneID(id uint64) *DictionaryDetailDeleteOne {
	builder := c.Delete().Where(dictionarydetail2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *DictionaryDetailClient) Get(ctx context.Context, id uint64) (*DictionaryDetail, error) {
	return c.Query().Where(dictionarydetail2.ID(id)).Only(ctx)
}
...
func (c *DictionaryDetailClient) QueryDictionaries(_m *DictionaryDetail) *DictionaryQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(dictionarydetail2.Table, dictionarydetail2.FieldID, id),
			sqlgraph.To(dictionary2.Table, dictionary2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, dictionarydetail2.DictionariesTable, dictionarydetail2.DictionariesColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *MenuClient) DeleteOneID(id uint64) *MenuDeleteOne {
	builder := c.Delete().Where(menu2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *MenuClient) Get(ctx context.Context, id uint64) (*Menu, error) {
	return c.Query().Where(menu2.ID(id)).Only(ctx)
}
...
func (c *MenuClient) QueryRoles(_m *Menu) *RoleQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(menu2.Table, menu2.FieldID, id),
			sqlgraph.To(role2.Table, role2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, menu2.RolesTable, menu2.RolesPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *MenuClient) QueryParent(_m *Menu) *MenuQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(menu2.Table, menu2.FieldID, id),
			sqlgraph.To(menu2.Table, menu2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, menu2.ParentTable, menu2.ParentColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *MenuClient) QueryChildren(_m *Menu) *MenuQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(menu2.Table, menu2.FieldID, id),
			sqlgraph.To(menu2.Table, menu2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, menu2.ChildrenTable, menu2.ChildrenColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *PositionClient) DeleteOneID(id uint64) *PositionDeleteOne {
	builder := c.Delete().Where(position2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *PositionClient) Get(ctx context.Context, id uint64) (*Position, error) {
	return c.Query().Where(position2.ID(id)).Only(ctx)
}
...
func (c *PositionClient) QueryUsers(_m *Position) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(position2.Table, position2.FieldID, id),
			sqlgraph.To(user2.Table, user2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, position2.UsersTable, position2.UsersPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *RoleClient) DeleteOneID(id uint64) *RoleDeleteOne {
	builder := c.Delete().Where(role2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *RoleClient) Get(ctx context.Context, id uint64) (*Role, error) {
	return c.Query().Where(role2.ID(id)).Only(ctx)
}
...
func (c *RoleClient) QueryMenus(_m *Role) *MenuQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(role2.Table, role2.FieldID, id),
			sqlgraph.To(menu2.Table, menu2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, role2.MenusTable, role2.MenusPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *RoleClient) QueryUsers(_m *Role) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(role2.Table, role2.FieldID, id),
			sqlgraph.To(user2.Table, user2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, role2.UsersTable, role2.UsersPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *UserClient) QueryDepartments(_m *User) *DepartmentQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(department2.Table, department2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, user2.DepartmentsTable, user2.DepartmentsColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *UserClient) QueryPositions(_m *User) *PositionQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(user2.Table, user2.FieldID, id),
			sqlgraph.To(position2.Table, position2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, user2.PositionsTable, user2.PositionsPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *UserClient) QueryRoles(_m *User) *RoleQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(user2.Table, user2.FieldID, id),
			sqlgraph.To(role2.Table, role2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, user2.RolesTable, user2.RolesPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *UserClient) Hooks() []Hook {
	hooks := c.hooks.User
	return append(hooks[:len(hooks):len(hooks)], user2.Hooks[:]...)
}

// Interceptors returns the client interceptors.
func (c *UserClient) Interceptors() []Interceptor {
	inters := c.inters.User
	return append(inters[:len(inters):len(inters)], user2.Interceptors[:]...)
}

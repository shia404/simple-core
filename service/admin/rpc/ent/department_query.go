...
func (_q *DepartmentQuery) Order(o ...department2.OrderOption) *DepartmentQuery {
...
func (_q *DepartmentQuery) QueryParent() *DepartmentQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(department2.Table, department2.FieldID, selector),
...
func (_q *DepartmentQuery) First(ctx context.Context) (*Department, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{department2.Label}
	}
	return nodes[0], nil
}
...
func (_q *DepartmentQuery) FirstID(ctx context.Context) (id uint64, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{department2.Label}
		return
	}
	return ids[0], nil
}
...
func (_q *DepartmentQuery) Only(ctx context.Context) (*Department, error) {
	...
	case 0:
		return nil, &NotFoundError{department2.Label}
	default:
		return nil, &NotSingularError{department2.Label}
	}
}
...
func (_q *DepartmentQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	...
	case 0:
		err = &NotFoundError{department2.Label}
	default:
		err = &NotSingularError{department2.Label}
	}
	return
}
...
func (_q *DepartmentQuery) IDs(ctx context.Context) (ids []uint64, err error) {
	...
	if err = _q.Select(department2.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *DepartmentQuery) Clone() *DepartmentQuery {
	...
	return &DepartmentQuery{
		config:       _q.config,
		ctx:          _q.ctx.Clone(),
		order:        append([]department2.OrderOption{}, _q.order...),
...
func (_q *DepartmentQuery) GroupBy(field string, fields ...string) *DepartmentGroupBy {
	...
	grbuild.label = department2.Label
...
func (_q *DepartmentQuery) Select(fields ...string) *DepartmentSelect {
	...
	sbuild.label = department2.Label
...
func (_q *DepartmentQuery) loadParent(ctx context.Context, query *DepartmentQuery, nodes []*Department, init func(*Department), assign func(*Department, *Department)) error {
	...
	query.Where(department2.IDIn(ids...))
...
func (_q *DepartmentQuery) loadChildren(ctx context.Context, query *DepartmentQuery, nodes []*Department, init func(*Department), assign func(*Department, *Department)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(department2.FieldParentID)
	}
	query.Where(predicate.Department(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(department2.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DepartmentQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Department, init func(*Department), assign func(*Department, *User)) error {
	...
	query.Where(predicate.User(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(department2.UsersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DepartmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(department2.Table, department2.Columns, sqlgraph.NewFieldSpec(department2.FieldID, field.TypeUint64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, department2.FieldID)
		for i := range fields {
			if fields[i] != department2.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(department2.FieldParentID)
		}
	}
...
func (_q *DepartmentQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(department2.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = department2.Columns
	}

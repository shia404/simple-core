...
type APIFunc func(context.Context, *ent2.APIMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f APIFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.APIMutation); ok {
		return f(ctx, mv)
	}
...
type ConfigurationFunc func(context.Context, *ent2.ConfigurationMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f ConfigurationFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.ConfigurationMutation); ok {
		return f(ctx, mv)
	}
...
type DepartmentFunc func(context.Context, *ent2.DepartmentMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f DepartmentFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.DepartmentMutation); ok {
		return f(ctx, mv)
	}
...
type DictionaryFunc func(context.Context, *ent2.DictionaryMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f DictionaryFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.DictionaryMutation); ok {
		return f(ctx, mv)
	}
...
type DictionaryDetailFunc func(context.Context, *ent2.DictionaryDetailMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f DictionaryDetailFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.DictionaryDetailMutation); ok {
		return f(ctx, mv)
	}
...
type MenuFunc func(context.Context, *ent2.MenuMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f MenuFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.MenuMutation); ok {
		return f(ctx, mv)
	}
...
type OauthProviderFunc func(context.Context, *ent2.OauthProviderMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f OauthProviderFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.OauthProviderMutation); ok {
		return f(ctx, mv)
	}
...
type PositionFunc func(context.Context, *ent2.PositionMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f PositionFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.PositionMutation); ok {
		return f(ctx, mv)
	}
...
type RoleFunc func(context.Context, *ent2.RoleMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f RoleFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.RoleMutation); ok {
		return f(ctx, mv)
	}
...
type TokenFunc func(context.Context, *ent2.TokenMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f TokenFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.TokenMutation); ok {
		return f(ctx, mv)
	}
...
func (f UserFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	if mv, ok := m.(*ent2.UserMutation); ok {
		return f(ctx, mv)
	}

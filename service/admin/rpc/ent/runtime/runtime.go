...
import (
	...
	schema2 "github.com/suyuan32/simple-admin-core/service/admin/rpc/ent/schema"
...
func init() {
	apiMixin := schema2.API{}.Mixin()
	apiMixinFields0 := apiMixin[0].Fields()
	_ = apiMixinFields0
	apiFields := schema2.API{}.Fields()
	_ = apiFields
	...
	configurationMixin := schema2.Configuration{}.Mixin()
	...
	configurationFields := schema2.Configuration{}.Fields()
	...
	departmentMixin := schema2.Department{}.Mixin()
	...
	departmentFields := schema2.Department{}.Fields()
	_ = departmentFields
	...
	dictionaryMixin := schema2.Dictionary{}.Mixin()
	...
	dictionaryFields := schema2.Dictionary{}.Fields()
	_ = dictionaryFields
	...
	dictionarydetailMixin := schema2.DictionaryDetail{}.Mixin()
	...
	dictionarydetailFields := schema2.DictionaryDetail{}.Fields()
	...
	oauthproviderMixin := schema2.OauthProvider{}.Mixin()
	oauthproviderMixinFields0 := oauthproviderMixin[0].Fields()
	_ = oauthproviderMixinFields0
	oauthproviderFields := schema2.OauthProvider{}.Fields()
	...
	positionMixin := schema2.Position{}.Mixin()
	...
	positionFields := schema2.Position{}.Fields()
	_ = positionFields
	...
	roleMixin := schema2.Role{}.Mixin()
	roleMixinFields0 := roleMixin[0].Fields()
	_ = roleMixinFields0
	roleMixinFields1 := roleMixin[1].Fields()
	_ = roleMixinFields1
	roleFields := schema2.Role{}.Fields()
	_ = roleFields
	...
	_ = userMixinFields1
	userFields := schema2.User{}.Fields()
	_ = userFields

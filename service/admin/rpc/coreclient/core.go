...
type (
	ApiInfo                  = core2.ApiInfo
	ApiListReq               = core2.ApiListReq
	ApiListResp              = core2.ApiListResp
	BaseIDResp               = core2.BaseIDResp
	BaseMsg                  = core2.BaseMsg
	BaseResp                 = core2.BaseResp
	BaseUUIDResp             = core2.BaseUUIDResp
	CallbackReq              = core2.CallbackReq
	ConfigurationInfo        = core2.ConfigurationInfo
	ConfigurationListReq     = core2.ConfigurationListReq
	ConfigurationListResp    = core2.ConfigurationListResp
	DepartmentInfo           = core2.DepartmentInfo
	DepartmentListReq        = core2.DepartmentListReq
	DepartmentListResp       = core2.DepartmentListResp
	DictionaryDetailInfo     = core2.DictionaryDetailInfo
	DictionaryDetailListReq  = core2.DictionaryDetailListReq
	DictionaryDetailListResp = core2.DictionaryDetailListResp
	DictionaryInfo           = core2.DictionaryInfo
	DictionaryListReq        = core2.DictionaryListReq
	DictionaryListResp       = core2.DictionaryListResp
	Empty                    = core2.Empty
	IDReq                    = core2.IDReq
	IDsReq                   = core2.IDsReq
	MenuInfo                 = core2.MenuInfo
	MenuInfoList             = core2.MenuInfoList
	MenuRoleInfo             = core2.MenuRoleInfo
	MenuRoleListResp         = core2.MenuRoleListResp
	Meta                     = core2.Meta
	OauthLoginReq            = core2.OauthLoginReq
	OauthProviderInfo        = core2.OauthProviderInfo
	OauthProviderListReq     = core2.OauthProviderListReq
	OauthProviderListResp    = core2.OauthProviderListResp
	OauthRedirectResp        = core2.OauthRedirectResp
	PageInfoReq              = core2.PageInfoReq
	PositionInfo             = core2.PositionInfo
	PositionListReq          = core2.PositionListReq
	PositionListResp         = core2.PositionListResp
	RoleInfo                 = core2.RoleInfo
	RoleListReq              = core2.RoleListReq
	RoleListResp             = core2.RoleListResp
	RoleMenuAuthorityReq     = core2.RoleMenuAuthorityReq
	RoleMenuAuthorityResp    = core2.RoleMenuAuthorityResp
	TokenInfo                = core2.TokenInfo
	TokenListReq             = core2.TokenListReq
	TokenListResp            = core2.TokenListResp
	UUIDReq                  = core2.UUIDReq
	UUIDsReq                 = core2.UUIDsReq
	UserInfo                 = core2.UserInfo
	UserListReq              = core2.UserListReq
	UserListResp             = core2.UserListResp
	UsernameReq              = core2.UsernameReq
...
func (m *defaultCore) CreateApi(ctx context.Context, in *ApiInfo, opts ...grpc.CallOption) (*BaseIDResp, error) {
	client := core2.NewCoreClient(m.cli.Conn())

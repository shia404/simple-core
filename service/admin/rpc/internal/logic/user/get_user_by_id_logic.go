...
func GetRoleIds(data []*ent2.Role) []uint64 {
	var ids []uint64
	for _, v := range data {
		ids = append(ids, v.ID)
	}
...
func GetRoleNames(data []*ent2.Role) []string {
	var codes []string
	for _, v := range data {
...
func GetRoleCodes(data []*ent2.Role) []string {
	var codes []string
	for _, v := range data {
...
func GetPositionIds(data []*ent2.Position) []uint64 {
	var ids []uint64
	for _, v := range data {
		ids = append(ids, v.ID)
	}

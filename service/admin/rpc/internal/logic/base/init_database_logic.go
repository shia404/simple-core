...
func (l *InitDatabaseLogic) insertProviderData() error {
	var providers []*ent2.OauthProviderCreate
...
func (l *InitDatabaseLogic) insertDepartmentData() error {
	var departments []*ent2.DepartmentCreate
